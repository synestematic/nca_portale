      ...
      <div id="page">
        ...
        <ul>
          <?php
            ...
            echo ($logged_user->su || $logged_user->full_name === "Caterina Rosa" || $logged_user->full_name === "Piero Mezzasalma" || $logged_user->full_name === "Alessio Calenda" || $logged_user->full_name === "Emilia Monita" || $logged_user->full_name === "Mattia Ruffoni") ? '<li><a href="fp_request?page=all"><b>FinProget:</b> Report All Vehicles</a></li><br>' : '';
            // echo (1 == 0) ? '<li><a href="fp_all" onclick="return trafficWarning();">Report Finproget ALL VEHICLES</a></li><br>' : '';
            ...
            // echo (1 == 0) ? '<li><a href="fp_warm" onclick="return trafficWarning();">Report Finproget WARM VEHICLES</a></li><br>' : '';
            ...
            // echo (1 == 0) ? '<li><a href="fp_merchants">Ricerca Merchants</a></li><br>' : '';
            ...
            // echo (1 == 0) ? '<li><a href="fp_atti">Report Finproget ATTI RICEVUTI</a></li><br>' : '';
