...
<div id="main">
 <div id="navigation">
  ...
  <ul class="pages">
		<?php
			...
			$veicolo_set = Veicolo::find_columns_from_table($requested_fields, $sql_table);
		?>
 ...
 <div id="page">
  <h2>Atti Ricevuti: <?php echo count($veicolo_set); ?> </h2>
   <table id="tavol">
			<?php
			echo '<tr>';
			$column_names = Veicolo::return_column_names($requested_fields, $sql_table);
